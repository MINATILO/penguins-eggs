...
eggs was born on Debian strecth/buster, but actually full support Debian from jessie to sid (bullseye), Devuan beowulf, Ubuntu focal, bionic and derivatives. I actually try it against Debian varius versions before to release it. I tried it successfully in LMDE 4 debbie, deepin and a lot of others. eggs, generally must work with all the derivates from that distros.
...
Eggs is realeased in 4 differents architectures: **i386**, **amd64**, **arm64** and **armel**. eggs - at the moment - produce in i386 and amd64, but can be installed already on arm64 and armel. This mean who it is possible to install it in [raspberrypi](https://www.raspberrypi.org/), but again not possible to produce a [Raspberry Pi OS](https://www.raspberrypi.org/software/) egg in armel or arm64. I'm working now to complete this step and I hope to receive good news from Mexico.
...
## deb packages
eggs is released as deb package for i386, amd64, armel and arm64 architectures. Due the characteristic of eggs, they can installed in Debian, Devuan or Ubuntu based distros, withouth worries about different versions, except for the architecture. The eggs package actually, bring inside alla the necessary scripts and dependencies management.
...
or, on a i386 system:
```
sudo dpkg -i eggs_8.0.30-1_i386.deb
```
### update
...
penguins-eggs/8.0.31 linux-x64 node-v8.17.0
$ eggs --help [COMMAND]
USAGE
  $ eggs COMMAND
...
...
_See code: [src/commands/adapt.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/adapt.ts)_
...
_See code: [src/commands/calamares.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/calamares.ts)_
...
_See code: [src/commands/config.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/config.ts)_
...
_See code: [src/commands/dad.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/dad.ts)_
...
_See code: [src/commands/export/deb.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/export/deb.ts)_
...
_See code: [src/commands/export/docs.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/export/docs.ts)_
...
_See code: [src/commands/export/iso.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/export/iso.ts)_
...
_See code: [src/commands/info.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/info.ts)_
...
_See code: [src/commands/install.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/install.ts)_
...
_See code: [src/commands/kill.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/kill.ts)_
...
_See code: [src/commands/mom.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/mom.ts)_
...
_See code: [src/commands/produce.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/produce.ts)_
...
_See code: [src/commands/remove.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/remove.ts)_
...
_See code: [src/commands/tools/clean.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/tools/clean.ts)_
...
_See code: [src/commands/tools/locales.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/tools/locales.ts)_
...
_See code: [src/commands/tools/skel.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/tools/skel.ts)_
...
_See code: [src/commands/tools/stat.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/tools/stat.ts)_
...
_See code: [src/commands/tools/yolk.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/tools/yolk.ts)_
...
_See code: [src/commands/update.ts](https://github.com/pieroproietti/penguins-eggs/blob/v8.0.31/src/commands/update.ts)_
<!-- commandsstop -->
